...
public class lang extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("ascension.runic.rune.flame", "Flame");
        add("ascension.runic.rune.water", "Water");
        add("ascension.runic.rune.wind", "Wind");
        add("ascension.runic.rune.earth", "Earth");
        add("ascension.runic.rune.wood", "Wood");
        add("ascension.runic.rune.metal", "Metal");
        add("ascension.runic.rune.lightning", "Lightning");
        add("ascension.runic.rune.frost", "Frost");
        add("ascension.runic.rune.bind", "Bind");
        add("ascension.runic.rune.push", "Push");
        add("ascension.runic.rune.pull", "Pull");
        add("ascension.runic.rune.guard", "Guard");
        add("ascension.runic.rune.cut", "Cut");
        add("ascension.runic.rune.heal", "Heal");
        add("ascension.runic.rune.bolt", "Bolt");
        add("ascension.runic.rune.veil", "Veil");
        add("ascension.runic.rune.circle", "Circle");
        add("ascension.runic.rune.mark", "Mark");
        add("ascension.runic.rune.quicken", "Quicken");
        add("ascension.runic.rune.stabilise", "Stabilise");
        add("ascension.runic.rune.gather", "Gather");
        add("ascension.runic.rune.release", "Release");
        add("ascension.runic.rune.pierce", "Pierce");
        add("ascension.runic.rune.compress", "Compress");
        add("ascension.runic.rune.wall", "Wall");
        add("ascension.runic.rune.pulse", "Pulse");
        add("ascension.runic.rune.heavy", "Heavy");
        add("ascension.runic.rune.violent", "Violent");
        add("ascension.runic.rune.hidden", "Hidden");
