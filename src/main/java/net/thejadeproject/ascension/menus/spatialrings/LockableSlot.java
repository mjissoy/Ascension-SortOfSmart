...
public class LockableSlot extends EasySlot {
    private final boolean locked;

    public LockableSlot(Inventory inventory, int slotIndex, int x, int y, boolean lock,String id)  {
        super(inventory, slotIndex, x, y,id);
        this.locked = lock;
    }
