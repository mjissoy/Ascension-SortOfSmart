...
public class MainScreen extends EasyGuiScreen {
    public MainScreen(Component title) throws IOException {
        ...
        */
        ...
        Label l1Title = (new Label.Builder()).screen(this).x(10).y(25).text(Component.literal("Progress:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l1 = (new Label.Builder()).screen(this).x(10).y(30).customScaling(0.5).width(140).build();
        Label l2Title = (new Label.Builder()).screen(this).x(10).y(35).text(Component.literal("Major Realm:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l2 = (new Label.Builder()).screen(this).x(10).y(40).customScaling(0.5).width(140).build();
        Label l3Title = (new Label.Builder()).screen(this).x(10).y(45).text(Component.literal("Minor Realm:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l3 = (new Label.Builder()).screen(this).x(10).y(50).customScaling(0.5).width(140).build();
        Label l4Title = (new Label.Builder()).screen(this).x(10).y(55).text(Component.literal("Max Health:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l4 = (new Label.Builder()).screen(this).x(10).y(60).customScaling(0.5).width(140).build();
        Label l5Title = (new Label.Builder()).screen(this).x(10).y(65).text(Component.literal("Health:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l5 = (new Label.Builder()).screen(this).x(10).y(70).customScaling(0.5).width(140).build();
        Label l6Title = (new Label.Builder()).screen(this).x(10).y(75).text(Component.literal("Armor:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l6 = (new Label.Builder()).screen(this).x(10).y(80).customScaling(0.5).width(140).build();
        Label l7Title = (new Label.Builder()).screen(this).x(10).y(85).text(Component.literal("Attack Damage:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l7 = (new Label.Builder()).screen(this).x(10).y(90).customScaling(0.5).width(140).build();
        ...
        Label l8 = (new Label.Builder()).screen(this).x(10).y(100).customScaling(0.5).width(140).build();
        Label l9Title = (new Label.Builder()).screen(this).x(10).y(105).text(Component.literal("Jump Strength:").withStyle(ChatFormatting.BOLD)).width(140).customScaling(0.5).build();
        Label l9 = (new Label.Builder()).screen(this).x(10).y(110).customScaling(0.5).width(140).build();
