...
public class SkillBarSkillSlot extends TextureButton {
    ...
    public PlayerSkillData.ActiveSkillContainer skillContainer;
    public SkillBarSkillSlot(IEasyGuiScreen easyGuiScreen, int x, int y, int skillSlot, PlayerSkillData.ActiveSkillContainer activeSkillContainer){
    ...
    public void renderSelf(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        textureData = getIcon(); // TODO find a way to optimize.... maybe an event?
