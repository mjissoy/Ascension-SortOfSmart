...
public class ModPaths {
    ...
    public static final DeferredHolder<IPath, ? extends GenericPath> ESSENCE_PATH = PATHS.register("essence",()->
            new GenericPath(ResourceLocation.fromNamespaceAndPath(AscensionCraft.MOD_ID,"essence"), Component.literal("Essence Path").withStyle(ChatFormatting.BOLD),
                    List.of(
    ...
    public static final DeferredHolder<IPath, ? extends GenericPath> INTENT_PATH = PATHS.register("intent",()->
            (new GenericPath(ResourceLocation.fromNamespaceAndPath(AscensionCraft.MOD_ID,"intent"), Component.literal("Intent Path").withStyle(ChatFormatting.BOLD),
                    List.of(
    ...
    public static final DeferredHolder<IPath, ? extends GenericPath> BODY_PATH = PATHS.register("body",()->
            new GenericPath(ResourceLocation.fromNamespaceAndPath(AscensionCraft.MOD_ID,"body"), Component.literal("Body Path").withStyle(ChatFormatting.BOLD),
                    List.of(
